...
def welcomepic(pic, user, chatname, id, uname, brightness_factor=1.3):
    ...
    font = ImageFont.truetype("InflexMusic/assets/fontwel1.ttf", size=95)
    welcome_font = ImageFont.truetype("InflexMusic/assets/fontwel1.ttf", size=45)
...
async def greet_new_member(
    ...
    if member.new_chat_member and not member.old_chat_member:
        ...
        try:
            ...
            deep_link = f"{user.id}"
            add_link = f"https://t.me/sarahmuisic_bot?startgroup=true"
